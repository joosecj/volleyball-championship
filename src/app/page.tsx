...
export default function Home() {
  ...
  const renderSection = () => {
    switch (activeSection) {
      ...
      case "matches":
        return (
          <Matches matches={tournament.schedule} groups={tournament.groups} />
        );
      case "bracket":
        return (
          <BracketComponent
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-sm opacity-90">
                Torneio de duplas de beach vôlei organizado pela Escola
                Professor Cezar. Competição amigável com foco no desenvolvimento
                esportivo.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm opacity-90 mb-3">
                Para dúvidas sobre o torneio, entre em contato com a
                organização.
              </p>
              <a
          ...
          <div className="border-t border-white/20 mt-8 pt-6">
            <p className="text-sm opacity-75">
              © 2025 Escola de Beach Vôlei Professor Cezar. Todos os direitos
              reservados.
              <br />
              Feito por{" "}
              <a
                href="https://github.com/joosecj"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1 text-yellow-300 hover:text-yellow-200 transition-colors"
              >
                <Rocket className="w-4 h-4" /> José Carlos
              </a>
            </p>
          </div>
        </div>
